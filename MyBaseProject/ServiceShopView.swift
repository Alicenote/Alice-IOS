...
class ServiceShopView: UIView {
    weak var delegate:ServiceShopViewDelegate?
    ...
    func nextClicked(){
        delegate?.nextFromServiceShopView()
    }
    
    func backClicked(){
        delegate?.backFromServiceShopView()
    }
    
    func nailServiceClicked(){
        delegate?.addNailService()
    }
    
    func hairServiceClicked(){
        delegate?.addHairService()
    }
}

protocol ServiceShopViewDelegate:class {
